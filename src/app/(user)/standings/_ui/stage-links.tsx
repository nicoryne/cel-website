        ...
        return (
          <li key={index}>
            <Link
              ...
              className={`${isSelected ? 'border-l-chili' : 'border-l-neutral-600'} border-l-2 px-4 py-2 font-bold uppercase shadow-sm transition-all duration-300 ease-in-out hover:text-pale`}
            >
              {stage}
            </Link>
          </li>
