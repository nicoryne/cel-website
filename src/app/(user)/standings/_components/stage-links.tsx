        ...
        return (
          <li key={index}>
            <Link
              ...
              className={`${isSelected ? 'border-l-chili' : 'border-l-neutral-600'} border-l-2 px-2 py-2 text-xs font-bold uppercase shadow-sm transition-all duration-300 ease-in-out hover:text-pale md:px-4 md:text-base`}
            >
              {stage}
            </Link>
          </li>
