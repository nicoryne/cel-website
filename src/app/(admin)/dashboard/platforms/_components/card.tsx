...
import { handleDelete, handleUpdate } from '@/app/(admin)/dashboard/platforms/_components/utils';
      ...
      <div className="flex gap-4 p-4">
        <div className="flex flex-col place-items-center gap-2">
          ...
          <div className="flex place-items-center gap-4">
            <ButtonUpdate
              onUpdate={() => handleUpdate(setModalProps, formData, platform, setCachedPlatforms)}
            />
            <ButtonDelete
              onDelete={() => handleDelete(setModalProps, platform, setCachedPlatforms)}
            />
          </div>
        </div>
