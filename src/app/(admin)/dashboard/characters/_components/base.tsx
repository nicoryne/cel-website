...
export default function CharactersClientBase({
  charactersCount,
  platformList
}: CharactersClientBaseProps) {
                ...
                <tr className="border-b-2 border-neutral-900 text-left" key={index}>
                  ...
                  <td className="px-2 py-3">
                    <div className="flex gap-8">
                      <ButtonUpdate
                        onUpdate={() =>
                          handleUpdate(setModalProps, formData, character, setCachedCharacters)
                        }
                      />
                      <ButtonDelete
                        onDelete={() => handleDelete(setModalProps, character, setCachedCharacters)}
                      />
                    </div>
                  </td>
                </tr>
