      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-col justify-center gap-4 md:flex-row">
          ...
          <div className="flex items-center justify-between gap-4">
            <div className="flex flex-col items-end space-y-12">
              ...
              {teamAMenu && (
                <motion.div
                  className="absolute z-40 grid grid-cols-3 rounded-md bg-[var(--background)] shadow-lg md:grid-cols-4"
        ...
        <div className="flex flex-1 flex-col gap-2">
          ...
          <div className="relative flex flex-col items-end space-y-12">
            ...
            {statusMenu && (
              <motion.div
                className="absolute z-40 flex w-full flex-col place-self-center rounded-md border-2 border-neutral-600 shadow-lg"
            ...
            <div className="relative flex flex-col items-end space-y-12">
              ...
              >
                ...
                <p className="text-xs md:text-base">
                  {seriesInfo.platform.platform_title || 'Select Platform'}
                </p>
              </button>
              ...
              {platformMenu && (
                ...
                >
                  {platformList.map((platform, index) => (
                    <button
                      className={`justify-left flex h-10 w-full place-items-center gap-2 px-4 text-neutral-300 hover:text-white ${
                        platform.id === seriesInfo.platform.id
                          ? 'bg-neutral-800'
                          : 'bg-[var(--background)]'
                      }`}
                      key={index}
        ...
        <div className="flex gap-4">
          ...
          <div className="relative flex flex-1 flex-col gap-2">
            ...
            <div className="flex flex-col items-end space-y-12 overflow-scroll">
              ...
              {scheduleMenu && (
                <motion.div
                  className="absolute z-40 flex h-80 w-80 flex-col place-self-center overflow-y-scroll rounded-md border-2 border-neutral-600 shadow-lg"
                  initial={{ opacity: 0, y: -10 }}
                  animate={{ opacity: 1, y: 0 }}
                >
                  {leagueScheduleList.map((schedule, index) => (
                    <button
                      className={`justify-left flex h-10 w-full place-items-center gap-2 px-4 text-neutral-300 hover:text-white ${
                        schedule.id === seriesInfo.league_schedule.id
                          ? 'bg-neutral-800'
                          : 'bg-[var(--background)]'
                      }`}
                      key={index}
