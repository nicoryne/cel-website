...
import { handleDelete, handleUpdate } from '@/app/(admin)/dashboard/maps/_components/utils';
      ...
      <div className="flex gap-4 p-4">
        <div className="flex flex-col place-items-center gap-2">
          ...
          <div className="flex place-items-center gap-4">
            <ButtonUpdate
              onUpdate={() => handleUpdate(setModalProps, formData, map, setCachedMaps)}
            />
