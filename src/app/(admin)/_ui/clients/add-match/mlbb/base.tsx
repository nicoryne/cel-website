...
import MatchDetailsForm from '@/app/(admin)/_ui/clients/add-match/mlbb/add-match-details/form';
import UploadPlayerStatisticsPanel from '@/app/(admin)/_ui/clients/add-match/mlbb/upload-image/panel';
import ValidatePlayerStatisticsPanel from '@/app/(admin)/_ui/clients/add-match/mlbb/validate-statistics/panel';
import ChooseSeries from '@/app/(admin)/_ui/clients/add-match/mlbb/choose-series/panel';
