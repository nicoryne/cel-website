    ...
    <footer id="site-footer" className="h-96 w-full bg-[var(--background)]">
      <div className="mx-auto grid h-full w-fit content-center gap-8 px-8 text-sm text-[var(--text-light)]">
        ...
        <section className="col-span-1" aria-labelledby="social-links">
          <h2 id="social-links" className="mb-1 font-bold">
            Follow Us
          </h2>
            ...
            {defaultSocials.map((social, index) => (
              <li key={index}>
                <a
                  ...
                  href={social.href}
                  aria-label={`Visit us on ${social.text}`}
                >
                  {social.logo}
                </a>
              </li>
        ...
        <nav className="col-span-1" aria-labelledby="footer-nav">
          <h2 id="footer-nav" className="font-bold">
            Navigate
          </h2>
          <ul>
            {defaultNavLinks.map((navLink, index) => (
              <li key={index}>
                <Link className="text-xs font-thin" href={navLink.href}>
                  {navLink.text}
                </Link>
              </li>
            ))}
        ...
        {/* Contacts Section */}
        <section className="col-span-1" aria-labelledby="contact-info">
          <h2 id="contact-info" className="mb-1 font-bold">
            Contact Us
          </h2>
          <address className="space-y-2 not-italic">
            <p className="flex gap-1">
              <EnvelopeIcon className="h-auto w-4 object-contain" />
              <a
                className="text-xs"
            ...
            <p className="flex gap-1">
              <PhoneIcon className="h-auto w-4 object-contain" />
        ...
        <section className="col-span-2 row-span-3 content-end text-center">
